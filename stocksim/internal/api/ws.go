...
// connection. This is a convenience push channel only — a client that
// misses messages (a dropped connection, a page it hadn't opened yet)
// always recovers via GET /api/state, never by relying on every individual
// push having arrived.
