...
export default function Benchmark() {
  ...
  // The run itself is server-side and keeps going regardless; this only decides
  // how often we ask about it. Gated so an open-but-unwatched page is silent.
  usePolling(async () => {
    try { setRun(await benchmarkApi.status(runId)) } catch { /* keep last */ }
  }, 800, { enabled: !!runId && active })
