...
export default function LogSummary() {
  ...
  // Works the same for an uploaded archive as for a captured one — and for a tab
  // that was already open, which a mount-only effect would have missed.
  useHandoff('ls.bundle', (bid) => open(bid))
