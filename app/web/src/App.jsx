...
const NAV = [
  ...
  { id: 'core-dump', label: 'Core Dump Analyzer', icon: 'Mineral', page: CoreDumpAnalyzer, hint: "Read a crashed server's core dump — threads, stack and arguments, without touching the server" },
